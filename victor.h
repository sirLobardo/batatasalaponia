...
printf("\n");
printf("aperte enter para continuar ou qualquer outra tecla para voltar para o menu \n");
}
...
printf("\n");
printf("aperte 3 para sair ou qualquer outra tecla para voltar para o menu");
} 
